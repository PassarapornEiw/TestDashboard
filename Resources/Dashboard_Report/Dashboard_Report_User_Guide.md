...
### 2.2 Pie Chart
**การอ่านกราฟ:**
- สีเขียว: Test Case ที่ผ่าน
- สีแดง: Test Case ที่ล้มเหลว
...
- **Status**: สถานะ (Pass/Fail/Not Run)
...
|---------|-------------|---------|
| **Latest Test Result** | ดูข้อมูลในส่วนบน | สถิติสรุปการทดสอบล่าสุด |
| **History** | ใช้แท็บและ Search | ประวัติการรันทั้งหมด |
| **View Details** | คลิกที่ Feature | รายละเอียด Test Case |
