...
|---------|--------|----------|-----------|
| **Latest Test Result** | ✅ Active | แสดงผลการทดสอบล่าสุด | ดูสถิติและกราฟ |
| **History Section** | ✅ Active | แสดงประวัติการรัน | ดูข้อมูลย้อนหลัง |
| **View Details** | ✅ Active | แสดงรายละเอียด Test Case | ดูข้อมูลเฉพาะเจาะจง |
